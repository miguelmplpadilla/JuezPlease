...
public class StartDialogueEmotionsNode : InputConectionNode {
	...
	[Tooltip("Este dialogo se ejcuta de forma normal, cuando el jugador tarde en decidir la resolucion")]
	[Output] public BaseNode normalDialogueOutput;
	[Tooltip("Este dialogo se ejecutara cuando el jugador tarde poco en decidir la resolucion")]
